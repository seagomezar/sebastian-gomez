  ...
  SearchService = function(options) {
    ...
    self.config = $.extend({
      ...
      selectors: {
        ...
        open_search: ".open-google-search"
      },
      brands: {
    ...
    self.buildResult = function(url, title, digest) {
      ...
      html +=     "<i class='fa fa-angle-right text-base icon-ml'></i>";
      html +=   "</a>";
      html += "</li>";
      return html;
    };
    ...
    self.init = function() {
      ...
      self.dom.open_search.on('click', self.open);
    };

    self.init();
  };

  var template = '<div id="u-search"><div class="modal"> <header class="modal-header" class="clearfix">'+
                 ...
                 '<i class="fa fa-search text-base icon-ml"></i> </button></form> <a class="btn-close">' +
                 '<i class="fa fa-close text-base icon-ml"></i> </a><div class="modal-loading">' + 
                 '<div class="modal-loading-bar"></div></div> </header> <main class="modal-body">'+
                 '<ul class="modal-results modal-ajax-content"></ul> </main> <footer class="modal-footer clearfix">' +
                 '<div class="modal-metadata modal-ajax-content"> <strong class="range"></strong> of <strong class="total">' + 
                 '</strong></div><div class="modal-error"></div> <div class="logo"></div> <a class="nav btn-next modal-ajax-content">' +
                 '<span class="text">NEXT</span> <i class="fa fa-angle-right text-base icon-ml"></i> </a> <a class="nav btn-prev modal-ajax-content">' +
                 '<i class="fa fa-angle-left text-base icon-ml"></i> <span class="text">PREV</span> </a> </footer></div><div class="modal-overlay"></div>' +
                 '</div>';
})(jQuery);
...
(function() {
  customSearch = new GoogleCustomSearch({
    apiKey: "AIzaSyA0ksIWVR-Z1zjr7iD1w9-GEz2Jh2XX9JU",
    engineId: "006296168491462573303:fhbil1dplk0"
  });
